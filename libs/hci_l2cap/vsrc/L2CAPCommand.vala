...
public class hciplus.L2CAPCommand : shotodol.M100Command {
	...
	public L2CAPCommand(L2CAPSpokesMan gspkr) {
		...
		addOption(&aclHandle, M100Command.OptionType.TXT, Options.ACL_HANDLE, &aclHelp);
		addOption(&l2capHandle, M100Command.OptionType.TXT, Options.L2CAP_CID, &l2capHelp);
	}
	...
	public override int act_on(etxt*cmdstr, OutputStream pad) {
		...
		do {
			...
			spkr.L2CAPSendInfo(aclHandle, l2capHandle);
			bye(pad, true);
			return 0;
		} while(false);
		bye(pad, false);
